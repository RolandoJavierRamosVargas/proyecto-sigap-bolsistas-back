...
public class CuentasPorCobrarRowMapper2 implements RowMapper<CuentasPorCobrar2>{
	...
	public CuentasPorCobrar2 mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		cuentasXcobrar2.setImporte_xpagar(rs.getInt("importe_xpagar"));
		cuentasXcobrar2.setImporte_pagado(rs.getInt("importe_pagado"));
		cuentasXcobrar2.setDeuda(rs.getInt("deuda"));
